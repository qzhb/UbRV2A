...
def parse_args():
    ...
    parser.add_argument('--ranking_loss_weight', default=1.0, type=float)
    parser.add_argument('--wd_loss_weight', default=1.0, type=float)
    parser.add_argument('--smooth', default=0.0, type=float)
    parser.add_argument('--smooth_value', default=0.4, type=float)
    parser.add_argument('--dropout', default=0.1, type=float)
    parser.add_argument('--feat_mse', default=0.0, type=float)
    parser.add_argument('--sigma', default=0.0, type=float)
    parser.add_argument('--verb', default=1.0, type=float)
    parser.add_argument('--noun', default=1.0, type=float)
    parser.add_argument('--next_cls', default=1.0, type=float)
    parser.add_argument('--eval_split', default='valid', type=str)
    parser.add_argument('--model_name', default='DCR', type=str)
