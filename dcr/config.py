...
root.model.loss.smooth_value = 0.
root.model.loss.ranking_loss_weight = 1.
root.model.loss.wd_loss_weight = 1.
...
def load_config(args= None):
    ...
    config.train.optimizer.base_lr = args.base_lr
    config.model.loss.ranking_loss_weight = args.ranking_loss_weight
    config.model.loss.wd_loss_weight = args.wd_loss_weight
    config.model.classifier.dropout = args.dropout
    config.model.loss.feat_mse = args.feat_mse
    config.model.loss.sigma = args.sigma
    config.model.loss.smooth = args.smooth
    config.model.loss.smooth_value = args.smooth_value
    config.model.loss.verb = args.verb
    config.model.loss.noun = args.noun
    config.model.loss.next_cls = args.next_cls
    config.eval.data.split = args.eval_split
    config.model.name = args.model_name
    config.train.optimizer.name = args.optimizer_name
